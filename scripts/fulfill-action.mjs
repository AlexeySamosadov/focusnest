/** Autonomous order fulfilment for FocusNest — GitHub Action on new issue.
...
comment(["✅ **Payment verified — your FocusNest Pro license:**", "", "Open FocusNest → **Unlock Pro** → *Have a key?* → paste:", "", "```", license, "```", "", "Lifetime, works offline. Thank you for supporting the app 💛"].join("\n"));
